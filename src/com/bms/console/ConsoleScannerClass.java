...
public class ConsoleScannerClass {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(nameSurname + ", " + age + ", is a great " + (gender == 'm' ? "guy" : "girl") + " with " + height + " meters height" + " and " + (gender == 'm' ? "he" : "she") + " reads bms.");
        ...
        System.out.println("Please enter your college degrees. To finish, enter bms website url");
        ...
        if (scanner.hasNext(Pattern.compile("www.bms.com")))
            System.out.println("Correct!");
        else
            System.out.println("bms website url is www.bms.com");
