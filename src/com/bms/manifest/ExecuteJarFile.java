...
public class ExecuteJarFile {
    ...
    private static final String WORK_PATH = "src/main/java/com/bms/manifest";
    private static final String MANIFEST_MF_PATH = WORK_PATH + "/MANIFEST.MF";
    private static final String MAIN_MANIFEST_ATTRIBUTE = "Main-Class: com.bms.manifest.AppExample";

    private static final String COMPILE_COMMAND = "javac -d . AppExample.java";
    private static final String CREATE_JAR_WITHOUT_MF_ATT_COMMAND = "jar cvf example.jar com/bms/manifest/AppExample.class";
    private static final String CREATE_JAR_WITH_MF_ATT_COMMAND = "jar cvmf MANIFEST.MF example.jar com/bms/manifest/AppExample.class";
